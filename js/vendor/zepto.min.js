...
var Zepto = (function () {
    ...
    function U(ac, ad) {
        var aa = ac.className, ab = aa && aa.baseVal !== m;
        if (ad === m) {
    ...
    F.fn = {forEach: O.forEach, reduce: O.reduce, push: O.push, sort: O.sort, indexOf: O.indexOf, concat: O.concat, map: function (aa) {
        ...
        if (ab) {
            return this.each(function (ad) {
                var ag = F(this), af = r(this, ab, ad, ag.offset()), ac = ag.offsetParent().offset(), ae = {top: af.top - ac.top, left: af.left - ac.left};
        ...
        return{left: aa.left + window.pageXOffset, top: aa.top + window.pageYOffset, width: Math.round(aa.width), height: Math.round(aa.height)}
    }, css: function (ac, ab) {
        ...
        return this.each(function (ab) {
            a = [];
            var ad = U(this), ac = r(this, aa, ab, ad);
        ...
        return this.each(function (ac) {
            var ae = F(this), ad = r(this, ab, ac, U(this));
        ...
        var ac = this[0], ab = this.offsetParent(), ad = this.offset(), aa = J.test(ab[0].nodeName) ? {top: 0, left: 0} : ab.offset();
    ...
    ["width", "height"].forEach(function (aa) {
        F.fn[aa] = function (ac) {
            var ae, ab = this[0], ad = aa.replace(/./, function (af) {
...
(function (b) {
    function a(d) {
        var g = this.os = {}, i = this.browser = {}, p = d.match(/WebKit\/([\d.]+)/), f = d.match(/(Android)\s+([\d.]+)/), q = d.match(/(iPad).*OS\s([\d_]+)/), o = !q && d.match(/(iPhone\sOS)\s([\d_]+)/), s = d.match(/(webOS|hpwOS)[\s\/]([\d.]+)/), n = s && d.match(/TouchPad/), m = d.match(/Kindle\/([\d.]+)/), l = d.match(/Silk\/([\d._]+)/), e = d.match(/(BlackBerry).*Version\/([\d.]+)/), k = d.match(/(BB10).*Version\/([\d.]+)/), c = d.match(/(RIM\sTablet\sOS)\s([\d.]+)/), r = d.match(/PlayBook/), h = d.match(/Chrome\/([\d.]+)/) || d.match(/CriOS\/([\d.]+)/), j = d.match(/Firefox\/([\d.]+)/);
        if (i.webkit = !!p) {
            i.version = p[1]
        }
        if (f) {
...
(function (c) {
    var h = c.zepto.qsa, o = {}, e = 1, k = {}, t = {mouseenter: "mouseover", mouseleave: "mouseout"};
    ...
    var p = function () {
        ...
        return false
    }, d = /^([A-Z]|layer[XY]$)/, j = {preventDefault: "isDefaultPrevented", stopImmediatePropagation: "isImmediatePropagationStopped", stopPropagation: "isPropagationStopped"};

    function b(x) {
        var w, v = {originalEvent: x};
        for (w in x) {
        ...
        return this.each(function (z, y) {
            l(y, w, x, v, function (A) {
                return function (D) {
                    ...
                    if (C) {
                        B = c.extend(b(D), {currentTarget: C, liveFired: y});
    ...
    c.Event = function (y, x) {
        ...
        var z = document.createEvent(k[y] || "Events"), v = true;
        if (x) {
            for (var w in x) {
...
(function (d, e) {
    var p = "", u, f, n, o = {Webkit: "webkit", Moz: "", O: "o", ms: "MS"}, l = window.document, a = l.createElement("div"), m = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i, j, q, i, k, h, t, s, r = {};
    ...
    d.fn.anim = function (B, x, w, D) {
        var C, z = {}, F, A = "", y = this, v, E = d.fx.transitionEnd;
        if (x === e) {
            x = 0.4
        }
        if (d.fx.off) {
...
(function (f) {
    var e = {}, g = f.fn.data, c = f.camelCase, h = f.expando = "Zepto" + (+new Date());
    ...
    function d(j) {
        ...
        f.each(j.attributes, function (l, k) {
            if (k.name.indexOf("data-") == 0) {
                i[c(k.name.replace("data-", ""))] = f.zepto.deserializeValue(k.value)
            }
        });
        return i
    }
...
(function (g) {
    var e = g.zepto, j = e.qsa, h = e.matches;
    ...
    var b = new RegExp("(.*):(\\w+)(?:\\(([^)]+)\\))?$\\s*"), d = /^\s*>/, i = "Zepto" + (+new Date());
...
(function (a) {
    ...
    "filter,add,not,eq,first,last,find,closest,parents,parent,children,siblings".split(",").forEach(function (c) {
        var b = a.fn[c];
        a.fn[c] = function () {
...
if (this.Zepto) {
    (function (c) {
        var a, b;
        a = function (g, j, i, h, d) {
            var f, e;
            if (g) {
                e = g[i]();
                f = {width: ["left", "right"], height: ["top", "bottom"]};
                f[i].forEach(function (k) {
                    e += parseInt(g.css("padding-" + k), 10);
                    if (h) {
                        e += parseInt(g.css("border-" + k + "-width"), 10)
                    }
                    if (d) {
                        return e += parseInt(g.css("margin-" + k), 10)
                    }
                });
                return e
            } else {
        ...
        ["width", "height"].forEach(function (i) {
            var h, f, g, d, e;
            h = i.replace(/./, function (j) {
                return j[0].toUpperCase()
            });
            (f = c.fn)[d = "inner" + h] || (f[d] = function (j) {
                return a(this, h, i, false, j)
            });
            return(g = c.fn)[e = "outer" + h] || (g[e] = function (j) {
                return a(this, h, i, true, j)
            })
        });
        return(b = c.fn).detach || (b.detach = function (e) {
            var d, f;
            f = this;
            if (e != null) {
                f = f.filter(e)
