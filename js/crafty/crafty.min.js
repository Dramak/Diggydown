...
(function (k, w, h) {
    ...
    x();
    r.fn = r.prototype = {init: function (D) {
        if (typeof D === "string") {
        ...
        return this
    }, addComponent: function (G) {
        var D = [], F = 0, C, B = 0, z, E, A;
        ...
        for (B in this) {
            if (B != "0" && B != "_global" && B != "_changed" && typeof this[B] != "function" && typeof this[B] != "object") {
                A[B] = this[B]
            }
        }
        return A
        ...
        if (r.support.setter) {
            ...
            if (r.support.defineProperty) {
                Object.defineProperty(this, A, {set: z, configurable: true})
            } else {
                a.push({prop: A, obj: this, fn: z})
            }
        }
        return this
    }, destroy: function () {
    ...
    r.extend({init: function (z, A, B) {
        r.viewport.init(z, A, B);
        this.trigger("Load");
        this.timer.init();
        return this
    }, getVersion: function () {
        ...
        return this._paused
    }, timer: {prev: (+new Date), current: (+new Date), currentTime: +new Date(), frames: 0, frameTime: 0, init: function () {
        var z = k.requestAnimationFrame || k.webkitRequestAnimationFrame || k.mozRequestAnimationFrame || k.oRequestAnimationFrame || k.msRequestAnimationFrame || null;
        if (z) {
            t = function () {
                r.timer.step();
                i = z(t)
        ...
        var z = k.cancelRequestAnimationFrame || k.webkitCancelRequestAnimationFrame || k.mozCancelRequestAnimationFrame || k.oCancelRequestAnimationFrame || k.msCancelRequestAnimationFrame || null;
        if (z) {
            z(i)
        }
        t = null
        ...
        if (this.currentTime > this.frameTime) {
            r.trigger("MessureFPS", {value: this.frame});
            this.frame = 0;
        ...
        var C = p[D], A, z, E, B;
        if (C === h || C.global === h || C.global.length === 0) {
            return false
        }
        if (arguments.length === 1) {
            delete C.global;
    ...
    (function (parent) {
        ...
        HashMap.prototype = {insert: function (obj) {
            ...
            var k, ent, hash = {max: {x: -Infinity, y: -Infinity}, min: {x: Infinity, y: Infinity}}, coords = {max: {x: -Infinity, y: -Infinity}, min: {x: Infinity, y: Infinity}};
        ...
        Entry.prototype = {update: function (rect) {
    ...
    Crafty.c("2D", {_x: 0, _y: 0, _w: 0, _h: 0, _z: 0, _rotation: 0, _alpha: 1, _visible: true, _globalZ: null, _origin: null, _mbr: null, _entry: null, _children: null, _parent: null, _changed: false, _defineGetterSetter_setter: function () {
        ...
        Object.defineProperty(this, "w", {set: function (v) {
            this._attr("_w", v)
        }, get: function () {
            return this._w
        }, configurable: true});
        Object.defineProperty(this, "h", {set: function (v) {
            this._attr("_h", v)
        }, get: function () {
            return this._h
        }, configurable: true});
        Object.defineProperty(this, "z", {set: function (v) {
            this._attr("_z", v)
        }, get: function () {
            return this._z
        }, configurable: true});
        Object.defineProperty(this, "rotation", {set: function (v) {
            this._attr("_rotation", v)
        }, get: function () {
            return this._rotation
        }, configurable: true});
        Object.defineProperty(this, "alpha", {set: function (v) {
            this._attr("_alpha", v)
        }, get: function () {
            return this._alpha
        }, configurable: true});
        Object.defineProperty(this, "visible", {set: function (v) {
            this._attr("_visible", v)
        }, get: function () {
            return this._visible
        }, configurable: true})
        ...
        var theta = -1 * (v % 360), rad = theta * DEG_TO_RAD, ct = Math.cos(rad), st = Math.sin(rad), o = {x: this._origin.x + this._x, y: this._origin.y + this._y};
        if (!theta) {
            this._mbr = null;
        ...
        this.trigger("Rotate", {cos: Math.cos(drad), sin: Math.sin(drad), deg: difference, rad: drad, o: {x: o.x, y: o.y}, matrix: {M11: ct, M12: st, M21: -st, M22: ct}})
    }, area: function () {
        ...
        return{_x: (this._mbr._x), _y: (this._mbr._y), _w: (this._mbr._w), _h: (this._mbr._h)}
    }, isAt: function (x, y) {
        if (this.mapArea) {
    ...
    Crafty.c("Physics", {_gravity: 0.4, _friction: 0.2, _bounce: 0.5, gravity: function (gravity) {
        this._gravity = gravity
    }});
    Crafty.c("Gravity", {_gravityConst: 0.2, _gy: 0, _falling: true, _anti: null, init: function () {
        this.requires("2D")
    ...
    Crafty.polygon.prototype = {containsPoint: function (x, y) {
    ...
    Crafty.circle.prototype = {containsPoint: function (x, y) {
    ...
    Crafty.matrix.prototype = {x: function (other) {
    ...
    Crafty.c("Collision", {init: function () {
        ...
        var points1 = poly1.points, points2 = poly2.points, i = 0, l = points1.length, j, k = points2.length, normal = {x: 0, y: 0}, length, min1, min2, max1, max2, interval, MTV = null, MTV2 = null, MN = null, dot, nextPoint, currentPoint;
        for (; i < l; i++) {
    ...
    Crafty.c("DOM", {_element: null, _cssStyles: null, init: function () {
        ...
        var style = this._element.style, coord = this.__coord || [0, 0, 0, 0], co = {x: coord[0], y: coord[1]}, prefix = Crafty.support.prefix, trans = [];
    ...
    Crafty.extend({DOM: {window: {init: function () {
    ...
    }, width: 0, height: 0}, inner: function (obj) {
        ...
        return{x: (x - Crafty.stage.x + document.body.scrollLeft + document.documentElement.scrollLeft - Crafty.viewport._x) / Crafty.viewport._zoom, y: (y - Crafty.stage.y + document.body.scrollTop + document.documentElement.scrollTop - Crafty.viewport._y) / Crafty.viewport._zoom}
    }}});
    Crafty.c("FPS", {values: [], maxValues: 60, init: function () {
    ...
    Crafty.storage = (function () {
        ...
        if (typeof indexedDB == "object") {
            return{open: function (gameName_n) {
                gameName = gameName_n;
                var stores = [];
                if (arguments.length == 1) {
                    stores.push("save");
                ...
                try {
                    var request = db.transaction([type], transactionType.READ_WRITE).objectStore(type).add({data: str, timestamp: t, key: key});
            ...
            if (typeof openDatabase == "function") {
                return{open: function (gameName_n) {
                    gameName = gameName_n;
                    if (arguments.length == 1) {
                        db = {save: openDatabase(gameName_n + "_save", "1.0", "Saves games for " + gameName_n, 5 * 1024 * 1024), cache: openDatabase(gameName_n + "_cache", "1.0", "Cache for " + gameName_n, 5 * 1024 * 1024)}
                    } else {
    ...
    Crafty.extend({zeroFill: function (number, width) {
        ...
        for (spriteName in map) {
            ...
            Crafty.c(spriteName, {ready: false, __coord: [x, y, w, h], init: function () {
        ...
        return this
    }, _events: {}, addEvent: function (ctx, obj, type, callback) {
    ...
    }, viewport: {clampToEntities: true, width: 0, height: 0, _x: 0, _y: 0, bounds: null, scroll: function (axis, v) {
        v = Math.floor(v);
        ...
        return function (axis, v, time) {
            ...
            tweens[axis] = {diff: -v / time, current: Crafty.viewport[axis], remTime: time};
            if (!bound) {
        ...
        function enterFrame() {
            if (dur > 0) {
                ...
                var old = {width: act.width * zoom, height: act.height * zoom};
                zoom += zoom_tick;
                Crafty.viewport._zoom = zoom;
                var new_s = {width: act.width * zoom, height: act.height * zoom}, diff = {width: new_s.width - old.width, height: new_s.height - old.height};
        ...
        return function (amt) {
            var bounds = this.bounds || Crafty.map.boundaries(), final_zoom = amt ? this._zoom * amt : 1, czoom = final_zoom / this._zoom;
            this._zoom = final_zoom;
            act.width = bounds.max.x - bounds.min.x;
            act.height = bounds.max.y - bounds.min.y;
            var new_s = {width: act.width * final_zoom, height: act.height * final_zoom};
            Crafty.viewport.pan("reset");
        ...
        return function (op, arg) {
            ...
            switch (op) {
                ...
                case"drag":
                    ...
                    diff = {x: arg.clientX - lastMouse.x, y: arg.clientY - lastMouse.y};
        ...
        if (typeof stage_elem === "string") {
            ...
            if (typeof HTMLElement !== "undefined" ? stage_elem instanceof HTMLElement : stage_elem instanceof Element) {
                crstage = stage_elem
            } else {
                throw new TypeError("stage_elem must be a string or an HTMLElement")
            }
        }
        Crafty.stage = {x: 0, y: 0, fullscreen: false, elem: (crstage ? crstage : document.createElement("div")), inner: document.createElement("div")};
    ...
    Crafty.c("viewport", {init: function () {
        this.bind("EnterFrame", function () {
    ...
    Crafty.extend({device: {_deviceOrientationCallback: false, _deviceMotionCallback: false, _normalizeDeviceOrientation: function (eventData) {
        var data;
        if (window.DeviceOrientationEvent) {
            data = {tiltLR: eventData.gamma, tiltFB: eventData.beta, dir: eventData.alpha, motUD: null}
        } else {
            if (window.OrientationEvent) {
                data = {tiltLR: eventData.x * 90, tiltFB: eventData.y * -90, dir: null, motUD: eventData.z}
            }
        }
        ...
        var data = {acceleration: acceleration, rawAcceleration: "[" + Math.round(acceleration.x) + ", " + Math.round(acceleration.y) + ", " + Math.round(acceleration.z) + "]", facingUp: facingUp, tiltLR: Math.round(((acceleration.x) / 9.81) * -90), tiltFB: Math.round(((acceleration.y + 9.81) / 9.81) * 90 * facingUp)};
    ...
    Crafty.c("Sprite", {__image: "", __tile: 0, __tileh: 0, __padding: null, __trim: null, img: null, ready: false, init: function () {
        this.__trim = [0, 0, 0, 0];
        var draw = function (e) {
    ...
    }, drawVars: {type: "canvas", pos: {}, ctx: null, coord: [0, 0, 0, 0], co: {x: 0, y: 0, w: 0, h: 0}}, draw: function (ctx, x, y, w, h) {
        if (!this.ready) {
            return
        }
    ...
    Crafty.extend({over: null, mouseObjs: 0, mousePos: {}, lastEvent: null, keydown: {}, selected: false, detectBlur: function (e) {
    ...
    Crafty.c("Draggable", {_origMouseDOMPos: null, _oldX: null, _oldY: null, _dragging: false, _dir: null, _ondrag: null, _ondown: null, _onup: null, init: function () {
        this.requires("Mouse");
    ...
    Crafty.c("Keyboard", {isDown: function (key) {
        if (typeof key === "string") {
            key = Crafty.keys[key]
        }
        return !!Crafty.keydown[key]
    }});
    Crafty.c("Multiway", {_speed: 3, _keydown: function (e) {
        if (this._keys[e.key]) {
        ...
        for (var k in this._keyDirection) {
            ...
            this._keys[keyCode] = {x: Math.round(Math.cos(this._keyDirection[k] * (Math.PI / 180)) * 1000 * speed.x) / 1000, y: Math.round(Math.sin(this._keyDirection[k] * (Math.PI / 180)) * 1000 * speed.y) / 1000}
        }
        return this
    }});
    Crafty.c("Fourway", {init: function () {
        ...
        this.multiway(speed, {UP_ARROW: -90, DOWN_ARROW: 90, RIGHT_ARROW: 0, LEFT_ARROW: 180, W: -90, S: 90, D: 0, A: 180, Z: -90, Q: 180});
        return this
    }});
    Crafty.c("Twoway", {_speed: 3, _up: false, init: function () {
        this.requires("Fourway, Keyboard")
    }, twoway: function (speed, jump) {
        this.multiway(speed, {RIGHT_ARROW: 0, LEFT_ARROW: 180, D: 0, A: 180, Q: 180});
        if (speed) {
            this._speed = speed
        }
    ...
    Crafty.c("Animation", {_reel: null, init: function () {
        this._reel = {}
    }, addAnimation: function (label, skeleton) {
        var key, lastKey = 0, i = 0, j, frame, prev, prop, diff = {}, p, temp, frames = [];
        for (key in skeleton) {
            frame = skeleton[key];
        ...
        var reel = this._reel[label], i = 0, l = reel.length, prop;
    ...
    Crafty.c("SpriteAnimation", {_reels: null, _frame: null, _currentReelId: null, init: function () {
        this._reels = {}
        ...
        if (arguments.length < 4 && typeof fromx === "number") {
            ...
            this._frame = {currentReel: currentReel, numberOfFramesBetweenSlides: Math.ceil(duration / currentReel.length), currentSlideNumber: 0, frameNumberBetweenSlides: 0, repeat: 0};
    ...
    Crafty.c("Tween", {_step: null, _numProps: 0, tween: function (props, duration) {
        this.each(function () {
            if (this._step == null) {
                this._step = {};
    ...
    Crafty.c("Color", {_color: "", ready: true, init: function () {
    ...
    Crafty.c("Image", {_repeat: "repeat", ready: false, init: function () {
        var draw = function (e) {
            if (e.type === "canvas") {
    ...
    Crafty.extend({_scenes: {}, _current: null, scene: function (name, intro, outro) {
        if (arguments.length === 1) {
    ...
    Crafty.DrawManager = (function () {
        ...
        var dirty_rects = [], changed_objs = [], dom = [], rectManager = {merge: function (a, b, target) {
            if (target == null) {
                target = {}
            }
        ...
        return{total2D: Crafty("2D").length, onScreen: function (rect) {
            ...
            if (!changed_objs.length && !dom.length) {
                return
            }
            var i = 0, l = changed_objs.length, k = dom.length, rect, q, j, len, obj, ent, ctx = Crafty.canvas.context;
            for (; i < k; ++i) {
    ...
    Crafty.extend({isometric: {_tile: {width: 0, height: 0}, _elements: {}, _pos: {x: 0, y: 0}, _z: 0, size: function (width, height) {
        ...
        obj.attr({x: pos.left + Crafty.viewport._x, y: pos.top + Crafty.viewport._y}).z += z;
        return this
    }, pos2px: function (x, y) {
        return{left: x * this._tile.width + (y & 1) * (this._tile.width / 2), top: y * this._tile.height / 2}
    }, px2pos: function (left, top) {
        return{x: Math.ceil(-left / this._tile.width - (top & 1) * 0.5), y: -top / this._tile.height * 2}
        ...
        return{x: {start: start.x, end: end.x}, y: {start: start.y, end: end.y}}
    }}});
    Crafty.c("Particles", {init: function () {
        ...
        this.deltaColour = [];
        this.sharpness = 0
    }, vectorHelpers: {create: function (x, y) {
        return{x: x, y: y}
    ...
    Crafty.extend({audio: {sounds: {}, supported: {}, codecs: {ogg: 'audio/ogg; codecs="vorbis"', wav: 'audio/wav; codecs="1"', webma: 'audio/webm; codecs="vorbis"', mp3: 'audio/mpeg; codecs="mp3"', m4a: 'audio/mp4; codecs="mp4a.40.2"'}, volume: 1, muted: false, paused: false, canPlay: function () {
            ...
            for (var i in id) {
                for (var src in id[i]) {
                    ...
                    if (this.supported[ext]) {
                        ...
                        this.sounds[i] = {obj: audio, played: 0, volume: Crafty.audio.volume}
                    }
                }
            }
        }
        if (typeof id === "string") {
            ...
            if (typeof url === "string") {
                ...
                if (this.supported[ext]) {
                    ...
                    this.sounds[id] = {obj: audio, played: 0, volume: Crafty.audio.volume}
                }
            }
    ...
    Crafty.c("Text", {_text: "", defaultSize: "10px", defaultFamily: "sans-serif", ready: true, init: function () {
        this.requires("2D");
        this._textFont = {type: "", weight: "", size: "", family: ""};
        this.bind("Draw", function (e) {
    ...
    Crafty.extend({assets: {}, asset: function (key, value) {
        if (arguments.length === 1) {
    ...
    }, image_whitelist: ["jpg", "jpeg", "gif", "png", "svg"], load: function (data, oncomplete, onprogress, onerror) {
        ...
        function pro() {
            ...
            ++j;
            if (onprogress) {
                onprogress({loaded: j, total: total, percent: (j / total * 100), src: src})
            }
        ...
        function err() {
            var src = this.src;
            if (onerror) {
                onerror({loaded: j, total: total, percent: (j / total * 100), src: src})
            }
            j++;
            if (j === total && oncomplete) {
                oncomplete()
        ...
        for (; i < l; ++i) {
            ...
            if (Crafty.support.audio && Crafty.audio.supported[ext]) {
                if (!obj) {
                    ...
                    Crafty.audio.sounds[name] = {obj: obj, played: 0}
                }
                if (obj.addEventListener) {
                    obj.addEventListener("canplaythrough", pro, false)
                }
            } else {
                if (Crafty.image_whitelist.indexOf(ext) >= 0) {
                    if (!obj) {
                        obj = new Image();
                        Crafty.asset(current, obj)
                    }
    ...
    Crafty.math.Matrix2D = (function () {
        ...
        Matrix2D.prototype.invert = function () {
            ...
            if (det !== 0) {
                var old = {a: this.a, b: this.b, c: this.c, d: this.d, e: this.e, f: this.f};
                this.a = old.d / det;
                this.b = -old.b / det;
                this.c = -old.c / det;
                this.d = old.a / det;
    ...
    Crafty.c("Delay", {init: function () {
        ...
        this._delays.push({start: new Date().getTime(), func: func, delay: delay, repeat: (repeat < 0 ? Infinity : repeat) || 0, pauseBuffer: 0, pause: 0});
        return this
    }})
});